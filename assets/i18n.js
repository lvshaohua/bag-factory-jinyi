...
(function() {
  ...
  const TRANSLATIONS = {
    ...
    // ===== Index Page =====
    'index_title': { 'zh': '袋尚工坊 - 上海帆布袋无纺布袋杜邦纸袋防水袋批量定制源头厂家', 'en': 'BagCraft Workshop - Custom Canvas/Non-woven/Tyvek/Waterproof Bags Factory Shanghai' },
    'index_desc': { 'zh': '袋尚工坊位于上海市嘉定区，专业定制帆布袋、无纺布袋、杜邦纸袋、防水袋。源头工厂直供，小批量100个起订，支持来图来样定制，7天快速交付。', 'en': 'BagCraft Workshop in Jiading, Shanghai. Custom canvas, non-woven, Tyvek and waterproof bags. Factory direct, 100 pcs MOQ, custom designs welcome, 7-day delivery.' },
    'index_og_title': { 'zh': '袋尚工坊 - 上海袋类批量定制源头厂家', 'en': 'BagCraft Workshop - Bulk Custom Bag Factory Shanghai' },
    'index_og_desc': { 'zh': '专业定制帆布袋、无纺布袋、杜邦纸袋、防水袋，小批量100个起订，源头工厂直供', 'en': 'Custom canvas, non-woven, Tyvek & waterproof bags. 100 pcs MOQ, factory direct from Shanghai.' },
    ...
    'index_hero_p': { 'zh': '专注帆布袋、无纺布袋、杜邦纸袋、防水袋的批量定制生产。支持来图来样定制，多种印刷工艺可选，<strong>100个起订</strong>，让品牌传播触手可及。', 'en': 'Specializing in bulk custom canvas, non-woven, Tyvek & waterproof bags. Send your design, multiple printing options, <strong>100 pcs MOQ</strong>. Make your brand visible everywhere.' },
    ...
    'index_products_h2': { 'zh': '四大品类，满足多元定制需求', 'en': 'Four Categories, Endless Possibilities' },
    ...
    // ===== Products Page =====
    'products_title': { 'zh': '产品中心 - 帆布袋无纺布袋杜邦纸袋防水袋定制 | 袋尚工坊', 'en': 'Products - Custom Canvas/Non-woven/Tyvek/Waterproof Bags | BagCraft Workshop' },
    'products_desc': { 'zh': '袋尚工坊产品中心：帆布袋、无纺布袋、杜邦纸袋、防水袋四大品类批量定制。上海市嘉定区源头工厂，100个起订，支持丝印热转印刺绣等多种工艺。', 'en': 'BagCraft Workshop products: canvas, non-woven, Tyvek & waterproof bags. Jiading Shanghai factory, 100 pcs MOQ, multiple printing techniques.' },
    'products_og_title': { 'zh': '产品中心 - 袋尚工坊', 'en': 'Products - BagCraft Workshop' },
    'products_og_desc': { 'zh': '帆布袋、无纺布袋、杜邦纸袋、防水袋四大品类批量定制', 'en': 'Four categories of custom bags in bulk quantities.' },
    'products_header_tag': { 'zh': '产品中心', 'en': 'Products' },
    'products_header_h1': { 'zh': '四大品类，满足多元定制需求', 'en': 'Four Categories, Endless Possibilities' },
    ...
    'process_step1_li1': { 'zh': '袋型选择：帆布袋 / 无纺布袋 / 杜邦纸袋 / 防水袋', 'en': 'Bag type: Canvas / Non-woven / Tyvek / Waterproof' },
    ...
    'contact_desc': { 'zh': '联系袋尚工坊获取免费报价。上海市嘉定区源头工厂，专业定制帆布袋、无纺布袋、杜邦纸袋、防水袋。电话131-4000-1380，100个起订。', 'en': 'Contact BagCraft Workshop for a free quote. Jiading Shanghai factory. Custom canvas, non-woven, Tyvek & waterproof bags. Tel: +86-13140001380. 100 pcs MOQ.' },
